...
$sql = "SELECT * FROM utilisateurs"; // mets le vrai nom de ta table
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Chiffres (Mensuelle)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">145.250XOF</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Chiffres (Annuel)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">2.550.123XOF</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Projets
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo htmlspecialchars($row['objet']); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-info btn-icon-split btn-sm" href="modifier.php?identifiant=<?php echo $row['identifiant']; ?>"> <span class="text">Modifier</span></a>
                                    <a class="btn btn-danger btn-icon-split btn-sm" href="supprimer.php?identifiant=<?php echo $row['identifiant']; ?>" onclick="return confirm('Es-tu sûr de vouloir supprimer ce message ?');"><span class="text">Supprimer</span></a>
                                </td>
                            </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
